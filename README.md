...
| **清理/收敛评估** | [S11 评估入口](https://cnb.cool/tryandrun/moonbit_dev/fast_qr_moonbit/-/blob/main/docs/02-证据/S11-无效代码与冗余文档清理评估.md) · [S11b 落地记录](https://cnb.cool/tryandrun/moonbit_dev/fast_qr_moonbit/-/blob/main/docs/02-证据/S11b-清理落地记录-v3-v5.md) |
| **改 / 新增文档** | [S12 文档体系规范](https://cnb.cool/tryandrun/moonbit_dev/fast_qr_moonbit/-/blob/main/docs/04-元/S12-文档体系SDD诊断与优化方案.md)（准入 CheckList · 状态字段 · 防漂移门禁 · 门禁自身审计 §13） |
