...
| [S1-数据结构-实现记录.md](./docs/S1-数据结构-实现记录.md) |
 ...
 **S1 落地记录**：S1 数据结构（ECL/Version/Mode/Mask/Module/QRCode/CompactQR）的真实实现、实测拍板决策（pub(all)/Array 矩阵/KEEP_LAST 32 位/错误推迟）与三后端全绿测试 |
