...
> **状态**：已失效　｜　日期：2026-09-05　｜　索引：[docs/README-导航与索引.md](README-导航与索引.md) §7
...
| 对象 | 当时的骨架代码（库注释文件 `fast_qr_moonbit.mbt` 仅含文档注释，CLI 仅 `println` 一行，测试 1 个冒烟用例）——**该文件已于 S11 v4 删除，见 [S11b](./S11b-清理落地记录-v3-v5.md) §12** |
