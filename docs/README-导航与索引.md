...
> **状态**：现行　｜　日期：2026-09-14　｜　索引：[docs/README-导航与索引.md](README-导航与索引.md) （本文件即导航面）
...
| **要改/新增文档** | [S12 文档体系规范](./S12-文档体系SDD诊断与优化方案.md)（准入 CheckList + 状态字段 + 链接纪律）→ 本文件 §8 全量清单 |
...
| [S12-文档体系SDD诊断与优化方案.md](./S12-文档体系SDD诊断与优化方案.md) | 文档体系规范与优化队列（**改文档前先读**） |
