...
> **状态**：现行　｜　日期：2026-09-12　｜　索引：[docs/README.md](../README.md) §2
...
> ⚠️ **2026-09-24 勘误**：上表 **P3 行「独立收益：联合上限 ≈1.26×」系 P2+P3 混算**（本文 **H1 已认**，
> **不得当独立收益**）。P3 单因子实测：扫描 ≈1.19×、真码整 build V40 ≈ **−15%**
> （[S9s](S9s-数组介质与字节加速-真实A-B实测.md)），且 **`FixedArray[Int]` 已于 `ea7d7ae` 落地**。
> 该 1.26× 与 S9m「≈0.5%（仅 RS）」两个旧口径**都没覆盖矩阵介质**；根因与治理见
> [S9t](S9t-介质换代延迟复盘与既有文档勘误.md)。
...
2. ~~P3 三向微基准~~ → **已做（2026-09-23，见 [S9s](S9s-数组介质与字节加速-真实A-B实测.md)）**：
