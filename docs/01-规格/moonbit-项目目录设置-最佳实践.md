...
> **状态**：现行　｜　日期：2026-09-05　｜　索引：[docs/README.md](../README.md) §6
...
[wasm-编译与运行-结果分析.md](../03-过程/wasm-编译与运行-结果分析.md) §5.1 的 440 B 一致）：
...
> 不得对其做符号链接（平台不保证 follow）——见 [README优化 §7.6](../04-元/README优化-冗余清理与最佳实践.md)。
...
> **v4 订正（2026-09-14，[S11b](../02-证据/S11b-清理落地记录-v3-v5.md) §12）**：本节原第 1 条曾要求
